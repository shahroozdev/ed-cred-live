...
const DisputeBtn = ({ id, disabled }: { id: number; disabled: boolean }) => {
  ...
  return (
    <>
      {disabled?<Button variant="ghost" icon={<Flag  stroke="black" fill="black"/>} disabled>
            {" "}
            {"  Disputed"}
          </Button>:<CustomModal
        title="Dispute Form"
                      ...
                      <div className="text-xs [&>ol>li]:ml-2">
                        ...
                        <ol>
                          <li>
                            ...
                            <br />
                            Begin by submitting a formal dispute request through
                            the <strong>Dispute Claim</strong> section on our
                            platform. Clearly state the specific review or claim
                            you wish to dispute.
                          </li>
                          <li>
                            <strong>
                          ...
                          <li>
                            ...
                            evaluate the submitted documentation and interviews
                            and assess whether the disputed claim can be
                            verified or invalidated.
                            <br />
                            <em>Please note</em> that the review process may
                            take up to <strong>two months</strong>, depending on
                            the time it takes to receive responses from the
                          ...
                          <li>
                            ...
                            sufficient documentation, the review or claim may be
                            removed or corrected. If the dispute cannot be
                            validated, the review will remain as is. You will be
                          ...
                          <li>
                            ...
                            transparency and fairness in resolving disputes, but
                            once the outcome is determined, no further revisions
                            to the claim or review will be made.
                          </li>
                        </ol>
                      </div>
                    ),
